...
public class TaskController {
	...
	@PostMapping
	public ResponseEntity<EntityModel<Task>> createTask(@RequestBody final TaskDTO taskDTO) {
	...
	@GetMapping(ONE_URL)
	public ResponseEntity<EntityModel<Task>> getTaskById(@PathVariable final String taskId) {
	...
	public ResponseEntity<Void> deleteTaskById(@PathVariable final String taskId) {
	...
	public ResponseEntity<EntityModel<Task>> updateTaskById(@PathVariable final String taskId,
	...
	public ResponseEntity<EntityModel<Task>> assignTask(@PathVariable final String taskId,
